...
> **olve_sau:**
> even after installing `gulp` and `gulp-cli` globally, I got the following error running any `gulp` command from above: 
>
> ```
...
> ```
>
> But they work if running them via `npx`: `npx gulp build-prod`.
